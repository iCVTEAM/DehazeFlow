...
def measure_dirs(dirA, dirB, use_gpu, verbose=False):
    ...
    for pathA, pathB in zip(paths_A, paths_B):
        ...
        t = time.time()
        # result['psnr'], result['ssim'], result['lpips'] = measure.measure(imCropCenter2(imread(pathA),(460,620)), imCropCenter2(imread(pathB),(460,620)))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default=r'D:\PycharmProjects\SRFlow-master\results\1033000\000', type=str)
    parser.add_argument('-dirB', default=r'D:\DataSet\SOTS\outdoor\gt', type=str)
